...
// Use the native token (AddressZero) as the default index token across chains.
// On Arbitrum this corresponds to ETH; on testnets it maps to their native token config.
export const DEFAULT_TOKEN = ethers.constants.AddressZero;
