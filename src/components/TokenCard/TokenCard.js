    ...
    <div className="Home-token-card-options">
      ...
      >
        ...
        <div className="Home-token-card-option-info">
          ...
          >
            <div>
              <span className="fz-sm fw-400 text-secondary">Arbitrum APR:</span>{" "}
          ...
          <div className="Home-token-card-option-action">
            <div className="buy">
              <BuyLink to="/buy-utx" className="fz-base text-primary fw-400" network={ARBITRUM}>
                <Button
                  className="fz-base text-primary fw-400"
                  variant="secondary"
                  textAlign="left"
                  imgInfo={{ src: utxLogo, alt: "Arbitrum" }}
                  newTab
                >
                  Buy on Arbitrum
                </Button>
      ...
      >
        ...
        <div className="Home-token-card-option-info">
          ...
          <div className="Home-token-card-option-action">
            <div className="buy">
              <BuyLink to="/buy-ulp" className="fz-base text-primary fw-400" network={ARBITRUM}>
                <Button
                  className="fz-base text-primary fw-400"
                  variant="secondary"
                  textAlign="left"
